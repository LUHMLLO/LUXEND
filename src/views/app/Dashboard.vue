<template>
  <div id="dashboard" :class="[theme.primary_color]">
    <section>
      <h1 class="font-4xl mb-0 uppercase">Dashboard</h1>
      <small class="font-sm">Administra tus pedidos pendientes y demas desde tu dahsboard</small>
    </section>
